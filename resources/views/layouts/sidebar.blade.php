<div class="main-nav">
               ...
               <div class="logo-box">
                    ...
                    <img src="{{asset ('assets/admin/images/logo.png') }}" class="logo-sm" alt="logo dark" style="width: 15%; height: auto;">
                    <img src="{{asset ('assets/admin/images/logo.png') }}" class="logo-lg" alt="logo dark" style="width: 15%; height: auto;">
                    </a>

                    <a href="{{route ('dashboard') }}" class="logo-light">
                    <img src="{{asset ('assets/admin/images/logo.png') }}" class="logo-sm" alt="logo light" style="width: 15%; height: auto;">
                    <img src="{{asset ('assets/admin/images/logo.png') }}" class="logo-lg" alt="logo light" style="width: 15%; height: auto;">
                    </a>
               </div>
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                         ...
                         <li class="nav-item">
                              <a class="nav-link" href="{{route ('peminjaman.index') }}">
                                   ...
                                   <span class="nav-text"> Peminjam </span>
                              </a>
                         </li>
