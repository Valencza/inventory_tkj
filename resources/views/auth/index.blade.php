                         ...
                         <div class="row justify-content-center h-100">
                              <div class="col-lg-6 py-lg-5">
                                   <div class="d-flex flex-column h-100 justify-content-center">
                                        ...
                                        <h2 class="fw-bold fs-24">Form Login</h2>

                                        <p class="text-muted mt-1 mb-4">Masukkan alamat email dan kata sandi Anda untuk mengakses panel admin.</p>

                                        <div class="mb-5">
                                             <form action="#" class="authentication-form">
                                                  <div class="mb-3">
                                                       <label class="form-label" for="example-email">Email</label>
                                                       <input type="email" id="example-email" name="example-email" class="form-control bg-" placeholder="Masukkan Email Anda">
                                                  </div>
                                                  <div class="mb-3">
                                                       <a href="auth-password.html" class="float-end text-muted text-unline-dashed ms-1">Reset password</a>
                                                       <label class="form-label" for="example-password">Password</label>
                                                       <input type="text" id="example-password" class="form-control" placeholder="Masukkan Password Anda">
                                                  </div>
                                                  <div class="mb-3">
                                                  ...
                                                  <!-- <button class="btn btn-soft-primary" type="submit">Masuk</button> -->
                                                       <a href="{{route ('dashboard') }}" class="btn btn-soft-primary" type="submit">Masuk</a>
                                                  </div>
                                             </form>
